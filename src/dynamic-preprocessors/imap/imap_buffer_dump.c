...
TraceBuffer buf[MAX_IMAP_BUFFER_DUMP] = {{"IMAP_CLIENT_DUMP", "", 0},
                                         {"IMAP_SERVER_DUMP", "", 0},
                                         {"IMAP_CLIENT_CMD_DUMP", "", 0},
                                         {"IMAP_SERVER_BODY_DATA_DUMP", "", 0}};
...
void dumpBufferInit(void) {
    unsigned int i;
    for (i = 0; i < MAX_IMAP_BUFFER_DUMP; i++) {
